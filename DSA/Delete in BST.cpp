...
int main() {
   ...
   cout<<"The mininmum element in the root is "<<endl;
   node *c=min_(root2);
   cout<<c->data<<endl;
   
   cout<<"The max value of the binary tree is given as "<<endl;
   node *a1=max_(root2);
   cout<<a1->data<<endl;
   cout<<"The answer by using the concept of the recursion is "<<endl;
   node *a2=maximum(root2);
   cout<<a2->data<<endl;
   
   node * a3=deleteinBST(root2,80);
   cout<<"The value after deleting the node is given as "<<endl;
   deleteinBST(root2,30);
   levelordertrivesal(root2);
    return 0;
}